					...
					VStack(alignment: .leading, spacing: 20) {
						...
						VStack(alignment: .leading, spacing: 16) {
							...
							KanaCardProgressView(
								title: "Hiragana",
								progress: model.hiraganaCountText,
								previewText: model.nextHiraganaRow,
								progressValue: model.hiraganaProgress
							)

							KanaCardProgressView(
								title: "Katakana",
								progress: model.katakanaCountText,
								previewText: model.nextKatakanaRow,
								progressValue: model.katakanaProgress
							)
